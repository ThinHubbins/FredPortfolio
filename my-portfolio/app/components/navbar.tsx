...
export default function Navbar() {
  ...
  const linkClass = (path: string) =>
    `flex items-center gap-2 rounded-full px-1.5 md:px-3 py-1 transition-all duration-300 ${
      pathname === path
  ...
  return (
    <nav className="p-3 fixed top-auto bottom-0 md:sticky md:top-0 w-full z-50 bg-white/20 dark:bg-black/30 shadow-lg md:backdrop-blur-sm">
      <div className="container mx-auto flex items-center justify-center md:grid md:grid-cols-3 md:items-center">

        {/* Left */}
        <div className="text-black dark:text-white text-md font-normal hidden md:block">
          Africa/Nigeria
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-black text-xs font-semibold rounded-full border border-gray-300 dark:border-gray-600 px-1 py-[0.125rem] flex items-center gap-2">
            ...
            {/* Mobile only */}
            <span className="inline-block w-px h-5 bg-gray-300 dark:bg-gray-600 mx-2 md:hidden"></span>
        ...
        {/* Right — desktop only */}
        <div className="hidden md:flex items-center justify-end gap-2 text-lg font-medium">
          <ThemeToggle isDark={isDark} onToggle={toggleTheme} />
